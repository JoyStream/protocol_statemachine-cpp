...
from base import ProtocolStateMachineBase
...
LOCAL_REPO_PATH_ENV = "PROTOCOL_STATEMACHINE_LOCAL_REPO_PATH"

class ProtocolStateMachineTesting(ProtocolStateMachineBase):
